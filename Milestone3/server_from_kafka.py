...
Name: Calvin
-----------------------------------------------
This file reads tweet from Kafka and write the 
information needed to compute the trendiness 
score to PostgreSQL.
"""
...
def main():
	...
	for message in consumer:
		...
		split_time_phrase(line, timegroup)
		split_time_word(line, timegroup)
